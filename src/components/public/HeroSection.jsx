    ...
    <section className="hero">
      ...
      <div className="hero-content">
        ...
        <h1 className="hero-title">
          Cérémonie de 
          <span className="hero-title-highlight"> récompense</span>
        </h1>

        <p className="hero-subtitle">
          Participez aux <strong>IMA Awards</strong> — Les plus grands artistes africains et francophones
          s'affrontent pour les prix les plus convoités de la scène musicale.
        </p>

        <div className="hero-countdown-wrapper">
          <p className="hero-countdown-label">Début des votes dans</p>
        ...
        <div className="hero-ctas">
          <button className="hero-btn-primary" onClick={() => navigate('/categories')}>
            ...
            <span className="hero-btn-icon"><TfiCup /></span>
