        ...
        <div className="container">
          <div className="page-hero-content">
            ...
            <p className="page-hero-desc">
              Les IMA Awards célèbrent l'excellence musicale africaine et francophone.
            </p>
          </div>
        </div>
      </div>
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="about-cta-section">
            ...
            <p className="about-cta-desc">Rejoignez des milliers de fans et soutenez vos artistes favoris.</p>
