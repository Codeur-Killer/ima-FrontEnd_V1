    ...
    <div className="home-page">
      ...
      <section className="stats-section">
        <div className="container">
          <div className="stats-grid">
            {[
              { value: artists.length || stats?.totalArtists || 26,      label: 'Artistes en compétition', icon: <PiMicrophoneStageFill /> },
              { value: categories.length || stats?.totalCategories || 5, label: 'Catégories',              icon: <TfiCup /> },
              { value: totalVotes,                                        label: 'Votes enregistrés',       icon: <LuClipboardList /> },
            ].map((stat, i) => (
      ...
      <section className="section">
        <div className="container">
          <div className="section-header">
            <div className="section-tag"><TfiCup /> Compétitions</div>
      ...
      {featuredArtists.length > 0 && (
        <section className="section featured-section">
          <div className="container">
            <div className="section-header">
              <div className="section-tag"><IoStarSharp /> Sélection</div>
              <h2 className="section-big-title">Artistes en vedette</h2>
              <p className="section-desc">Les artistes qui font vibrer la scène musicale africaine cette année.</p>
            </div>
      ...
      <section className="section how-to">
        <div className="container">
          <div className="section-header">
            <div className="section-tag"><LiaClipboardListSolid /> Guide</div>
            <h2 className="section-big-title">Comment voter ?</h2>
          </div>
          <div className="how-steps">
            {[
              { step:'01', icon:<FaSearch />, title:'Choisissez une catégorie',  desc:"Parcourez les catégories et découvrez les artistes nominés." },
              { step:'02', icon:<PiMicrophoneStageFill />, title:'Sélectionnez votre artiste', desc:"Consultez les profils et choisissez qui vous souhaitez soutenir." },
              { step:'03', icon:<GiVote />, title:'Votez et soutenez',          desc:"Votez et multipliez votre soutien via FedaPay pour plus de votes." },
            ].map((s, i) => (
