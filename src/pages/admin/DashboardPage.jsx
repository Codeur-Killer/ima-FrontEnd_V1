  ...
  return (
    <div className="dashboard-page">
      ...
      <div className="db-weight-banner">
        <span className="db-weight-title"><GiInjustice /> Pondération officielle :</span>
        <span className="db-weight-item db-weight-free">🆓 Gratuit <strong>20%</strong></span>
        <span className="db-weight-sep">·</span>
        <span className="db-weight-item db-weight-paid"><FaRegCreditCard /> Payant <strong>60%</strong></span>
        <span className="db-weight-sep">·</span>
        <span className="db-weight-item db-weight-jury"><FaUserTie /> Jury <strong>20%</strong> <em>(interne)</em></span>
      </div>

      <div className="dashboard-content">
        {/* ── KPI Cards ── */}
        <div className="dashboard-stats-grid db-stats-6">
          <StatsCard icon="🗳️" title="Total votes publics" value={totalVotes}      color="gold"   />
          ...
          <StatsCard icon="👨‍⚖️" title="Votes jury"        value={totalVotesJury}  color="pink"   />
        ...
        {activeTab === 'overview' && (
          <div className="db-tab-content">
            ...
            <div className="dashboard-main-grid">
              <div className="dashboard-chart-wrap">
                <div className="db-card">
                  <div className="db-card-header">
                    <h3><FaChartLine /> Évolution 7 jours</h3>
              ...
              <div className="db-card">
                <div className="db-card-header">
                  <h3><TfiCup /> Top 5 — Score pondéré</h3>
                ...
                <div key={catId} className="db-card db-ranking-card">
                  ...
                  <div className="db-ranking-table">
                    <div className="db-ranking-header">
                      ...
                      <span style={{color:'#10B981'}}>🆓 Gratuit</span>
                      <span style={{color:'#7C3AED'}}>💳 Payant</span>
                      <span style={{color:'#F59E0B'}}>👨‍⚖️ Jury</span>
        ...
        {activeTab === 'evolution' && (
          <div className="db-tab-content">
            <div className="db-card">
              <div className="db-card-header"><h3><IoStatsChartOutline /> Votes par type — 7 derniers jours</h3></div>
            ...
            <div className="db-card">
              <div className="db-card-header"><h3><TbMoneybagPlus /> Revenus FedaPay — 7 jours</h3></div>
              <ResponsiveContainer width="100%" height={220}>
        ...
        {activeTab === 'recent' && (
          <div className="db-tab-content">
            <div className="db-card">
              <div className="db-card-header">
                <h3><FaClockRotateLeft /> 50 derniers votes</h3>
                        ...
                        <tr key={v.id||i}>
                          ...
                          <td>
                            <span className={`badge ${v.type==='payant'?'badge-purple':v.type==='jury'?'badge-warning':'badge-success'}`}>
                              {v.type==='payant'?' Payant':v.type==='jury'?' Jury':' Gratuit'}
                            </span>
                          </td>
