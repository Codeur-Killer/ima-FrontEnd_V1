    ...
    <div className="admin-login-page">
      ...
      <div className="admin-login-card">
        <div className="admin-login-logo">
          {/* <div className="admin-login-logo-text">IMA</div> */}
        ...
        <form onSubmit={handleSubmit} className="admin-login-form">
          ...
          <button type="submit" className="admin-login-btn" disabled={loginLoading}>
            {loginLoading ? <><span className="btn-spinner"/> Connexion...</> : <><span><FaLockOpen /></span> Se connecter</>}
          </button>
        </form>

        <div className="admin-login-hint">
          {/* <p>Credentials : <code>admin@ima-awards.com</code> / <code>admin123</code></p> */}
        </div>
      </div>
    </div>
  );
