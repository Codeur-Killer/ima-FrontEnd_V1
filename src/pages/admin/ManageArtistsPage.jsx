                    ...
                    <tr key={aid}>
                      ...
                      <td>
                        <div style={{display:'flex',gap:6}}>
                          <button className="manage-action-btn manage-action-edit" style={{ color: "#fff" }} onClick={()=>openEdit(artist)}><FiEdit /></button>
                          <button className="manage-action-btn manage-action-delete" style={{ color: "red" }} onClick={()=>setDeleteConfirm(aid)}><RiDeleteBin7Fill /></button>
                        </div>
                      </td>
                    </tr>
                  );
                ...
                <div className="photo-upload-zone" onClick={()=>fileInputRef.current?.click()}>
                  {photoPreview
                    ...
                    : <div className="photo-upload-placeholder">
                        <span style={{fontSize:32}}><AiFillPicture /></span>
